...
<body>
<script type="text/javascript">$(function(){$('body').prepend('<div id="upgrade-component-tips" style="z-index: 999999;" class="upgrade-tips"><a href="<?php  echo url('cloud/upgrade');?>">您使用的系统是简易版,请注册云服务更新到完整版！</a></div>');});</script>